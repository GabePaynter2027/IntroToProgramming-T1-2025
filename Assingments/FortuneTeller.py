...
def fortune_teller():
    ...
    print("I will tell your fortune using your numbers.\n")
    ...
    try:
        ...
        if score < 20:
            ...
            print("You will meet someone who changes your day.")
        elif score < 80:
            print("A small risk will lead to big rewards.")
        else:
            print("Good fortune and happiness are on their way to you!")
